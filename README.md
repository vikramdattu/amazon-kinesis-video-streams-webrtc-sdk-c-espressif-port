...
These components are **no longer bundled** in this repository. Remove any `override_path` entries pointing to them. The standard versions from the [ESP Component Registry](https://components.espressif.com) will be resolved automatically:
