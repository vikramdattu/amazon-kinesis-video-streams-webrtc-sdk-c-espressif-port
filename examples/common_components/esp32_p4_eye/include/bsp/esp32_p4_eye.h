...
#if CONFIG_BSP_AUDIO_SPEAKER_SUBBOARD
/* ES8311 speaker subboard */
#define BSP_AUDIO_SUBBOARD_I2C_SCL   BSP_I2C_SCL
#define BSP_AUDIO_SUBBOARD_I2C_SDA   BSP_I2C_SDA
#define BSP_AUDIO_SUBBOARD_I2S_MCLK  (GPIO_NUM_53)
#define BSP_AUDIO_SUBBOARD_I2S_BCLK  (GPIO_NUM_6)
#define BSP_AUDIO_SUBBOARD_I2S_LRCK  (GPIO_NUM_7)
#define BSP_AUDIO_SUBBOARD_I2S_DATA  (GPIO_NUM_8)
#define BSP_AUDIO_SUBBOARD_PA_CTRL   (GPIO_NUM_10)
#endif
...
/**
 * @brief Get I2C bus handle (compatibility alias)
 ...
 * I2S audio interface
 *
 * The audio resources in this BSP are:
 *  - MEMSensing Microsystems MSM261S4030H0: onboard PDM digital microphone
 *  - ES8311: optional speaker subboard codec
 *
 * The ES8311 speaker subboard is enabled by CONFIG_BSP_AUDIO_SPEAKER_SUBBOARD.
 * Its codec and I2S resources are initialized only when requested by the user.
 **************************************************************************************************/

/**
 * @brief Init ES8311 speaker subboard I2S audio
 *
 * @note Available only when CONFIG_BSP_AUDIO_SPEAKER_SUBBOARD is enabled.
 * @note There is no deinit audio function. Users can free audio resources by calling i2s_del_channel()
 * @warning The type of i2s_config param is depending on IDF version.
 * @param[in]  i2s_config I2S configuration. Pass NULL to use default values (Mono, TX, 16bit, 22050 Hz)
 * @return
 *      - ESP_OK                On success
 *      - ESP_ERR_NOT_SUPPORTED Speaker subboard support is disabled
...
/**
 * @brief Initialize microphone codec device (compatibility alias for PDM mic)
 * @return Pointer to codec device handle or NULL when error occurred
 */
esp_codec_dev_handle_t bsp_audio_codec_microphone_init(void);

/**
 * @brief Read data from the onboard PDM microphone codec
 *
 * @note This API is unrelated to the optional ES8311 speaker subboard.
 *
 * @param[in]  audio_buffer Audio buffer
