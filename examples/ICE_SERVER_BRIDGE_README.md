...
**Location**: `components/signaling_serializer/`
...
**Location**: `examples/signaling_only/`
...
**Location**: `examples/streaming_only/components/bridge_signaling/`
...
- `components/signaling_serializer/` - Message serialization
- `examples/signaling_only/main/signaling_only_main.c` - Sender logic
- `examples/streaming_only/components/bridge_signaling/` - Receiver logic
- `components/kvs_webrtc/src/app_webrtc.c` - ICE server retrieval
- `components/kvs_webrtc/src/Tls_esp.c` - ESP-TLS for TURN over TCP
