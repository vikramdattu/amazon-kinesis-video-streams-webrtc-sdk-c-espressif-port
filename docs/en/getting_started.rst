...
The patches are located in ``patches/``:
...
.. code-block:: bash
   ...
   cd $IDF_PATH
   git am -i <path-to-sdk>/patches/0001-ets_sys-Fix-for-STATUS-define.patch
   cd -
...
.. code-block:: bash
   ...
   cd $IDF_PATH
   git am -i <path-to-sdk>/patches/0002-Fixes-for-IDF-deep-sleep-and-lwip_split_for_esp_host.patch
   cd -
...
2. Place your certificates in the SPIFFS image directory:
   ...
   .. code-block:: none
      ...
      examples/app_common/spiffs_image/certs/
